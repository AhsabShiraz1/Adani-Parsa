...
export default function AchLevel4({ setNotification }: LevelProps) {
  ...
  return (
    <>   
      <Environment 
        files="/assets/anr-reception.hdr"
        background 
        ground={{
          height: 5,     
          radius: 100,    
          ...
          >
            <Container flexDirection="column" alignItems="flex-start">
              ...
              <Text fontSize={10} fontWeight="medium">
                * You are now at the reception area on 10th floor.
              </Text>
              <Text fontSize={10} fontWeight="medium">
